...
#Output 
'''Enter the first sequence: ABCDEGTEYUEUF
Enter the second sequence: ZQRSTUDGASVAHD

Longest Common Subsequence: TU
Length of LCS: 2
'''
...
'''Enter the first sequence: AQRSTUVW
Enter the second sequence: XYZAQUSBIOPL

Longest Common Subsequence: AQU
Length of LCS: 3
'''
